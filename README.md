...
# Screenshots
![Twin Card Game Preview](./my-app/src/assets/images/startplay.png)
![Twin Card Game Preview](./my-app/src/assets/images/done.png)
...
```bash
git clone https://github.com/katelynyew/twin-card-game.git
cd twin-card-game
